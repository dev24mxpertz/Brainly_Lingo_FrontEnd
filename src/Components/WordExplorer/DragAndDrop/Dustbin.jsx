    ...
    <div ref={drop} style={{ ...style, backgroundColor }} data-testid="dustbin" className='QuesCard'>
      ...
      <div className='droppedItem'>
        ...
        <div className='droppedImg'>
          {isMatched ? <img  src={` https://ik.imagekit.io/dev24/${matchedImg}`} alt='box' className='imgLastDropped' />
           : lastDroppedItem ?
            <img  src={` https://ik.imagekit.io/dev24/${lastDroppedItem}`} alt='box' className='imgLastDropped' /> : ""
          }
        </div>
        </div>
        <div className=' h-[10%]'>
          <p className='font-poppins font-normal Synonyms'>Synonyms: <span className='text-white'>{Synonyms}</span></p>
          <p className='font-poppins font-normal  Antonyms'>Antonyms: <span className='text-white'>{Antonyms}</span></p>
        </div>
      </div>
      {/* : <p className='questext'>{text}
          </p> */}
