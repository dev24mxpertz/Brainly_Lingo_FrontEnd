        ...
        <div className="flex flex-wrap justify-center content-start items-center font-semibold tracking-normal leading-5 text-white  tabsBg">
            <div className=" flex gap-4  tabs-container">
             <div className=' flex gap-4 innerTabBox'>
                ...
                <div className={`flex flex-1 gap-2 justify-center items-center scienceTabs ${activeTab === 3 ? 'bg-[linear-gradient(93deg,#761DE8_-2.94%,#29BDEC_200.14%)]' :'border-violet-700 border-solid bg-[linear-gradient(93deg,#761DE8_-2.94%,#29BDEC_56.14%)]'} : 'bg-white bg-opacity-10'} rounded-[1000px] max-md:px-5`} onClick={() => handleTabClick(3,"")}>
